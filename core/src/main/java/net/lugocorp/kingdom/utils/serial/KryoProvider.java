...
class KryoProvider {
    ...
    static Kryo getKryo() {
        ...
        kryo.register(net.lugocorp.kingdom.game.model.fields.Inventory.class);
        kryo.register(net.lugocorp.kingdom.game.model.fields.Inventory.InventoryType.class);
        kryo.register(net.lugocorp.kingdom.game.model.Fate.class);
        kryo.register(net.lugocorp.kingdom.game.model.glyph.Glyph.class);
        ...
        kryo.register(net.lugocorp.kingdom.game.model.glyph.GlyphCategory.class);
        kryo.register(net.lugocorp.kingdom.game.model.fields.UnitGlyphs.class);
        kryo.register(net.lugocorp.kingdom.game.model.fields.Tags.class);
