...
/**
 * This shader renders Tiles in the Game World
 */
public class TileShader implements Shader {
    ...
    @Override
    public void init() {
        String fragment = Gdx.files.internal("shaders/tile/fragment.glsl").readString();
        String vertex = Gdx.files.internal("shaders/tile/vertex.glsl").readString();
    ...
    public void begin(Camera camera, RenderContext context) {
        ...
        this.program.setUniformf(this.u_timer, (float) (System.currentTimeMillis() % TileShader.TIMER_MAX));
    }
